# CUYRA Catalog Cloud V4.1.0 · UI02 + COMMERCEUX01 + CATALOGANALYTICS01
...
4. Verificar `/api/health` → `CUYRA Catalog Cloud`, `4.1.0`.
5. Probar primero `/c/daca-sport` con productos reales, variantes, filtros, WhatsApp y móvil.
6. Confirmar que logo/colores/datos de Daca Sport siguen siendo protagonistas.
7. Solo después hacer merge a `main` / Production.
