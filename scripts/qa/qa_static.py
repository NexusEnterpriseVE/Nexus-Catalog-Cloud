...
need('public/sw.js','cuyra-catalog-v4.3.0','/api/')
...
need('api/health.ts','CUYRA Catalog Cloud','4.3.0')
need('public/nexus-admin-tenant-7f4b2.html','noindex,nofollow,noarchive','CUYRA Catalog Cloud','V4.3.0')
need('public/nexus-admin-tenant-7f4b2.js','admin-rotate-sofia-token','x-admin-secret','VERSION = "4.3.0"')
